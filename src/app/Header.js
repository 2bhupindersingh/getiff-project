...
const Header = () => {
  ...
  // Check if current path is our-story
    ...
    <nav className="navigation">
      <Stack direction="horizontal" gap={3}>
        <Link href="/" className="me-auto">
          <Image src={logo} width={111} height={42} alt="Picture of the author" className="logo" />
        </Link>
        {!isOurStoryPage && (
          <Link href="/our-story" className="btn btn-outline-primary">
            Our Story
          </Link>
        )}
        {!isButtonHidden && (
